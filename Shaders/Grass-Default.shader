Shader "Hollow Knight/Grass-Default" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #if ETC1_EXTERNAL_ALPHA && FRAMERATE_SNAPPING && PIXELSNAP_ON // :DX11VertexSM40
            struct appdata
            {
            ...
            float _SnappedFramerate; // 72 (starting at cb0[4].z)
            ...
            float _PushAmount; // 68 (starting at cb0[4].y)
            ...
            v2f vert(appdata v)
            {
                ...
                float4 tmp0;
                float4 tmp1;
                tmp0.x = _Time.y * _SnappedFramerate + 0.5;
                tmp0.x = floor(tmp0.x);
                tmp0.x = tmp0.x / _SnappedFramerate;
                tmp0.y = unity_ObjectToWorld._m23 + unity_ObjectToWorld._m03;
                tmp0.y = tmp0.y * _WorldOffset;
                tmp0.x = tmp0.x * _SwaySpeed + tmp0.y;
                tmp0.x = sin(tmp0.x);
            ...
            #elif ETC1_EXTERNAL_ALPHA && FRAMERATE_SNAPPING // :DX11VertexSM40
            struct appdata
            {
                float4 vertex : POSITION;
                float4 color : COLOR;
            ...
            #elif FRAMERATE_SNAPPING && PIXELSNAP_ON // :DX11VertexSM40
            struct appdata
            {
                float4 vertex : POSITION;
                float4 color : COLOR;
            ...
            #elif FRAMERATE_SNAPPING // :DX11VertexSM40
            struct appdata
            {
                float4 vertex : POSITION;
                float4 color : COLOR;
            ...
            #if ETC1_EXTERNAL_ALPHA && FRAMERATE_SNAPPING && PIXELSNAP_ON // :DX11PixelSM40
            struct fout
            {
            ...
            #elif ETC1_EXTERNAL_ALPHA && FRAMERATE_SNAPPING // :DX11PixelSM40
            struct fout
            {
                float4 sv_target : SV_Target;
            };
            ...
            #elif FRAMERATE_SNAPPING && PIXELSNAP_ON // :DX11PixelSM40
            struct fout
            {
                float4 sv_target : SV_Target;
            };
            ...
            #elif FRAMERATE_SNAPPING // :DX11PixelSM40
            struct fout
            {
                float4 sv_target : SV_Target;
            };
