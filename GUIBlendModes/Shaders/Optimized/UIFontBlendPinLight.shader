Shader "UI/BlendModes/Font/Optimized/PinLight" {
    ...
    SubShader {
        ...
        Pass {
            ...
            sampler2D _GUIBlendingSharedGT; // 1
            ...
            fout frag(v2f inp)
            {
                ...
                tmp0 = tex2D(_GUIBlendingSharedGT, tmp0.xz);
                tmp1.xyz = inp.color.xyz - float3(0.5, 0.5, 0.5);
                tmp1.xyz = tmp1.xyz + tmp1.xyz;
                tmp1.xyz = max(tmp0.xyz, tmp1.xyz);
                tmp2.xyz = inp.color.xyz + inp.color.xyz;
                tmp0.xyz = min(tmp0.xyz, tmp2.xyz);
                tmp2.xyz = inp.color.xyz > float3(0.5, 0.5, 0.5);
