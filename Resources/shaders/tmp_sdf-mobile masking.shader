...
Shader "TextMeshPro/Mobile/Distance Field - Masking" {
    ...
    SubShader {
        ...
        Pass {
            ...
            float _MaskWipeControl; // 464 (starting at cb0[29].x)
            float _MaskEdgeSoftness; // 468 (starting at cb0[29].y)
            float4 _MaskEdgeColor; // 480 (starting at cb0[30].x)
            float _MaskInverse; // 496 (starting at cb0[31].x)
