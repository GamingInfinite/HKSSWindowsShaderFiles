...
Shader "TextMeshPro/Bitmap" {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 _FaceColor; // 32 (starting at cb0[2].x)
            float _VertexOffsetX; // 48 (starting at cb0[3].x)
            float _VertexOffsetY; // 52 (starting at cb0[3].y)
            ...
            v2f vert(appdata v)
            {
                ...
                o.texcoord1.xy = tmp0.zw * float2(0.00195313, 0.00195313);
